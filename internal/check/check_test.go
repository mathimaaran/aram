...
func TestCheckValidCorpus(t *testing.T) {
	names := []string{"வணக்கம்.aram", "எண்கணிதம்.aram", "நிபந்தனை.aram", "கூட்டு.aram", "பதிப்பு.aram", "சுழல்.aram", "சரம்.aram", "பட்டியல்.aram", "பலபட்டியல்.aram", "பட்டியல்_அமைப்பு.aram", "ஒவ்வொரு.aram", "சேர்.aram", "சேர்_வளர்.aram", "ஆக்கு.aram", "அகராதி.aram", "அகராதி_எழுத்து.aram", "அகராதி_விசை_வளர்.aram", "தள்ளிவை.aram", "தள்ளிவை_முறை.aram", "இருமி.aram", "பொதுவகை.aram", "பலமதிப்பு.aram", "பெயர்_முடிவு.aram", "பரிமாற்றம்.aram", "வகை_மாற்று.aram", "மிதவை.aram", "தமிழ்_இலக்கம்.aram", "மாற்றுதல்.aram", "மாற்றுதல்_மேல்.aram", "நிலையான.aram", "அமைப்பு.aram", "அமைப்பு_நிலை.aram", "சுட்டி.aram", "முறை.aram", "இன்மை.aram", "வளர்_அமைப்பு.aram", "திசைவி.aram", "தொடக்கம்_நிபந்தனை.aram", "அமைப்பு_சமம்.aram", "பதிப்பி_அமைப்பு.aram"}
